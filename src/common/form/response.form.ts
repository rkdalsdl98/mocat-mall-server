...
export const ERROR: Record<string, ResponseFailedForm> = {
    ...
    "UnAuthorized": { statuscode: 401, data: null, message: "해당 요청에 필요한 자격 증명에 실패 했습니다." },
    ...
    "BadGateway": { statuscode: 502, data: null, message: "요청을 처리하지 못했습니다.\n네트워크 장치를 확인 한 이후에 다시 시도해주세요." },
    "ServiceUnavailableException": { statuscode: 503, data: null, message: "현재 해당 요청을 처리할 수 없습니다.\n나중에 다시 시도해주세요."},
